...
## Locomotion
### Humanoid
- arXiv 2026 **RPL**: Learning Robust Humanoid Perceptive Locomotion on Challenging Terrains, [Website](https://rpl-humanoid.github.io/)
...
### Quadruped
- ICRA 2026, Flexible Locomotion Learning with Diffusion Model Predictive Control, [Website](https://flexible-diffusion-mpc.github.io/)
...
## Manipulation
- ICRA 2026, **Compose by Focus**: Scene Graph-based Atomic Skills, [Website](https://computationalrobotics.seas.harvard.edu/SkillComposition/)
- NeurIPS 2025, **Touch in the Wild**: Learning Fine-Grained Manipulation with a Portable Visuo-Tactile Gripper,[Website](https://binghao-huang.github.io/touch_in_the_wild/)
- CoRL 2025, **DexUMI**: Using Human Hand as the Universal Manipulation Interface for Dexterous Manipulation, [Website](https://dex-umi.github.io/)
- arXiv 2025, **Dexterity from Smart Lenses**: Multi-Fingered Robot Manipulation with In-the-Wild Human Demonstrations, [Website](https://aina-robot.github.io/)
- arXiv 2025, **π*0.6**: a VLA that Learns from Experience, [Website](https://www.pi.website/blog/pistar06)
...
- arXiv 2025, Multi-Modal Manipulation via Multi-Modal Policy Consensus, [Website](https://policyconsensus.github.io/)
- CoRL 2025, **ReWiND**: Language-Guided Rewards Teach Robot Policies without New Demonstrations, [Website](https://rewind-reward.github.io/)
